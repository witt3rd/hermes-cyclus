...
author: "Addy Osmani"
author_role: "Director of Engineering, Google DeepMind (formerly Engineering Director, Google Chrome)"
url: "https://addyosmani.com/blog/loop-engineering/"
retrieved: "2026-07-07"
relevance: >
  Independent convergence on the same design Cyclus implements: the five loop
  primitives (automations, worktrees, skills, plugins/connectors, sub-agents) map
  directly onto Hermes cron, git worktrees, SKILL.md, hermes-cyclus, and
  delegate_task respectively. Osmani's framing — "build it like someone who intends
  to stay the engineer" — is load-bearing for Cyclus's design thesis. His worktrees
  section also surfaces the file-isolation problem for concurrent workers that is
  tracked in hermes-cyclus issue #1.
---
