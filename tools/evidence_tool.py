"""
cyclus_evidence tool — run build/test/lint commands and collect structured output.
...
CYCLUS_EVIDENCE_SCHEMA = {
    "name": "cyclus_evidence",
    "description": (
...
def cyclus_evidence_handler(args: dict, **kwargs) -> str:
    config = get_config()
